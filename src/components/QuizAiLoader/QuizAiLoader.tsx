    ...
    <div className="loaderBlock">
      ...
      <div className="btn-save-block">
        ...
        <p className="quiz-generation-note">
          ...
          цель теста, уровень сложности, целевую аудиторию и примеры желаемых вопросов.
        </p>
        <p className="quiz-generation-note">
          При запросах, содержащих цензурируемые слова или затрагивающих чувствительные или цензурируемые темы,
