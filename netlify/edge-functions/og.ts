...
export default async (request: Request) => {
  try {
    ...
    let description =
      "ANY QUIZ — платформа для создания, публикации и прохождения тестов, квизов и викторин. Создавайте" +
      " собственные тесты, делитесь ими по ссылке и проверяйте знания бесплатно.";
